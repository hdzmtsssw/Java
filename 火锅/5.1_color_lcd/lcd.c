...
#ifdef CHINESE_VERSION
	lcd_disp_hz16(10,10,BLUE,"wwww");
#else
	lcd_disp_ascii8x16(10,10,BLUE,"Happy");
#endif
	lcd_disp_ascii8x16(10,24,(UINT8T)(GREEN-55),"Beijing");
	
	/* draw rectangle pattern */ 
	lcd_draw_box(10,40,310,230,RED);
	lcd_draw_box(20,45,300,225,GREEN);
	lcd_draw_box(30,50,290,220,BLUE);
	lcd_draw_box(40,55,280,215,(UINT8T)(GREEN-55));
